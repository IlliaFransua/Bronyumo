...
urlpatterns = [
    path('check-booking-availability/<str:entity_hash>/<str:map_image_hash>/',
         CheckBookingAvailabilityAPI.as_view(),
         name='check-booking-availability-api'),

    path('create-booking/<str:entity_hash>/<str:map_image_hash>/',
         CreateBookingAPI.as_view(),
         name='create-booking-api'),

    path('upload-and-delete-bookings/<str:entity_hash>/<str:map_image_hash>/',
         UploadAndDeleteBookingsAPI.as_view(),
         name='upload-and-delete-bookings-api'),

    path('upload-and-preserve-bookings/<str:entity_hash>/<str:map_image_hash>/',
         UploadAndPreserveBookingsAPI.as_view(),
         name='upload-and-preserve-bookings-api'),
#
    path('add-for-booking/<str:entity_hash>/<str:map_image_hash>/',
         AddForBookingAPI.as_view(),
         name='add-for-booking-api'),

    path('remove-from-booking/<str:entity_hash>/<str:map_image_hash>/',
         RemoveFromBookingAPI.as_view(),
         name='remove-from-booking-api'),

    path('share-booking/<str:entity_hash>/<str:map_image_hash>/',
    ...
    path('delete-booking-entry/<str:entity_hash>/<str:map_image_hash>/',
